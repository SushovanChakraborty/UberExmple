...
public class UberExmpleApp {

    private static final Logger log = LoggerFactory.getLogger(UberExmpleApp.class);

    private final Environment env;

    public UberExmpleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes UberExmple.
     * <p>
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(UberExmpleApp.class);
